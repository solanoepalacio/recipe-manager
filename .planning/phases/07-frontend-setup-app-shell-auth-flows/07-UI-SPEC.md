...
> Generated by gsd-ui-researcher from hi-fi designs at plans/01_App/hifi/01_auth.html and plans/01_App/hifi/02_app_shell.html.
...
| View | File |
|------|------|
| Auth (login, register, forgot password) | `plans/01_App/hifi/01_auth.html` |
| App shell (TopBar, Drawer, recipe list) | `plans/01_App/hifi/02_app_shell.html` |
...
| Decision | Source |
|----------|--------|
| Font: Outfit | Extracted from plans/01_App/hifi/01_auth.html and plans/01_App/hifi/02_app_shell.html |
...
| Navigation items | Extracted from plans/01_App/hifi/02_app_shell.html drawer |
